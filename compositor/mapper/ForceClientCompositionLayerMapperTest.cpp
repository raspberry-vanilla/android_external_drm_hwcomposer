...
TEST(ForceClientCompositionLayerMapperTest, Force) {
  ForceClientCompositionLayerMapper mapper;
...
TEST(ForceClientCompositionLayerMapperTest, NegativeValidatorNoEffect) {
  ForceClientCompositionLayerMapper mapper;
